...
| US2 | As a **student**, I want to I want to mark my attendance so that my attendance is recorded automatically. | FR3, FR4, FR5 | - Attendance password is checked successfully.<br>- System verifies the password.<br>- Attendance is saved in the database. |
...
| US5 | As a **lecturer**, I want to generate a QR code for each class session so that students can record their attendance quickly. | FR2 | - Attendance password is generated successfully.<br>- Attendance password is unique for each class session. |
